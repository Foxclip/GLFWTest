...
void Cube::render(glm::mat4 pView, glm::mat4 pProjection, glm::vec3 lightPos, glm::vec3 lightDir) {
    ...
    material.getShader().setVec3("light.position", glm::vec3(pView * glm::vec4(lightPos, 1.0f)));
